...
# base class for two-class models detecting different types of images
class Detector():
    def __init__(self,kfold=1,modelname='profile_model',epochs=50,domodel=True):
        ...
        self.class0dir = None # not the detected item
        self.class1dir = None # the detected item
